/*   
    A simple test of BRAM read/write using the PS's built-in DMA
...
int main() {
    ...
    xil_printf("-------------- Starting Simple BRAM Read/Write Test using DMA ------------\n\r");
    ...
    int rxBuff[TXSIZE]__attribute__((aligned(4096)));
    ...
    *txDone = 0;
    ...
    DmaCmd.ChanCtrl.DstBurstLen = 4;
    DmaCmd.ChanCtrl.DstInc = 1;
    DmaCmd.BD.SrcAddr = (u32) bram;
    DmaCmd.BD.DstAddr = (u32) rxBuff;
    DmaCmd.BD.Length = TXSIZE * sizeof(int);
