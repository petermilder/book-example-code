// Module for reserving buffers for use with DMA

// Author: Giuseppe DiGuglielmo
// Project: https://github.com/GiuseppeDiGuglielmo/dma_alloc_coherent_zynqmp

// Modified, 2018-08-04, Peter Milder
